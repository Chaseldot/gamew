# 05 Mainline Quest Skeleton

状态：ground truth
日期：2026-04-26
用途：定义《山水照影录》主线任务骨架的设计层级、统一战役目标、三章章级结构和后续区域 / 任务设计约束。旧剧情蓝本、章节细稿、网站内容和 `history/` 中的历史方案与本文冲突时，以本文为准。
...
- 三章地图地点清单，相关 ground truth 见 `03-map-design.md`；
- 单个任务剧本、对白、场景卡；
...
- 政治阵营结构和机构认知边界，相关 ground truth 见 `04-political-faction-restructure.md`。
...
| 3 | 区域层 | 每章用什么空间承载自由探索、压力和结算？ | 区域结构、地点清单、路线关系、相位规则。 |
...
牒针、稳心验脉、引脉和显影归档的客观机制以 `02-world-setting.md` 为准。缉武司、同尘盟和照影局分别知道多少，以 `04-political-faction-restructure.md` 为准。
...
本节只保留当前三章关系预览。三章大区、地点清单和地点气质以 `03-map-design.md` 为准；本文不重复维护地图地点表。
