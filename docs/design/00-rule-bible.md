...
- **流派** 是当前唯一固定层。
- **传承、旁修、出身 / 身份、角色形象** 都可以在 pressure loop 中按需修改。
...
- 传承必须从所属流派的资源循环与动作结构中长出来，不能靠旁修或身份成立。
...
### 出身 / 身份
叙事、社会关系、开局资源与世界交互层，例如僧人、捕快、医谷、杀手楼、门派弟子。
...
约束：主修 / 流派必须独立成立，不依赖旁修、出身或角色形象补完核心闭环。
...
- `05-identity-and-archetypes.md`：canon systems designer, reviewed by wuxia fantasy reviewer
...
4. CRPG reviewer 判定没有 mandatory tax、无 counterplay 爆发或身份压扁问题；
