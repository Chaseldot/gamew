...
- Modify generated: `docs/reference/website-blueprint/site/data.js`
...
**Files:**
- Replace major sections in: `docs/reference/website-blueprint/site/app.js`
