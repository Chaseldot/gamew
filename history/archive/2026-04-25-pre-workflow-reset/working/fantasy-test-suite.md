...
| F-021 | 拂尘清客型 | worker-1 | 2 | pass | 2 | 拂尘作为软兵 / 兵刃表现已可由游锋边界承载；“道人 / 道门”身份仍 deferred。 |
| F-022 | 铁伞书生型 | worker-1 | 2 | pass | 2 post-rewrite | 铁伞已可由游锋 close-weapon expression 或奇门 device / carrier expression 成立；WUX-011 已解。 |
| F-023 | 牵丝傀儡师型 | worker-1 | 2 | block / deferred | 2 post-rewrite | 可见傀儡道具 / 诱饵 / NPC 演出可 pass；独立参战 puppet 版本仍 block。见 WUX-012。 |
| F-024 | 玉箫行客型 | worker-1 | 2 | pass | 2 | 音律对器乐无固定职业绑定，清音 / 魔音与游锋接口足以承载行客幻想。 |
...
## Round 2 full cumulative regression test — worker-1

- Baseline tested: current canon in this worktree after the Round 1 rewrite packet; no explicit human-added Round 2 fantasies found in current docs.
- Coverage: F-001 ~ F-024 cumulative suite.
- Result: 21 pass / 1 revise / 2 block-deferred.
- Regressions from prior PASS: none. F-001 ~ F-017、F-019 ~ F-021、F-024 remain pass; F-018 remains the existing block-deferred item and no prior pass fell to revise / block.
- New worker-origin fantasies this round: F-021 ~ F-024 (4 items; no explicit human-origin additions found in current docs).
- New tickets opened: WUX-011, WUX-012.

### Round 2 item notes

- F-021 拂尘清客型 — **pass**：游锋主修及其软兵边界现在已经能把拂尘解释为低魔近身兵刃表现，连锋负责贴身不断、断势负责拂尘缠腕破架；“清客 / 出尘”是角色形象标签，不需要把道人身份拉回当前 round。
- F-022 铁伞书生型 — **revise**：当前 canon 能分别解释游锋软兵 / 兵刃表现、奇门器具载体和射艺远端触发，但“铁伞”这种一眼可见的 hybrid 道具仍缺一条明确归位规则。玩家容易把伞同时读成护身兵刃、机关壳体、暗器容器与布置媒介，进而把多个主轴能力压进同一造型里。见 WUX-011。
- F-023 牵丝傀儡师型 — **block / deferred**：如果只是“场上摆着可见傀儡、假人、木偶作为诱饵 / 演出 / 一次性机关载体”，奇门机关已可承载；但若玩家要的是傀儡独立移动、牵制、夹击、承伤、接力触发或占格换位，就已经是 future minion / puppet system，而不是本轮机关传承或角色形象能偷渡解决的范围。见 WUX-012。
- F-024 玉箫行客型 — **pass**：音律当前写法本就不是“只限古琴”的职业壳，清音已直接覆盖琴箫类稳场表达，魔音也能解释更孤绝的压拍版本；若玩家要箫声后接近身收束，游锋旁修接口已足够补出行走江湖、箫声开局、贴身追击的小循环。

## Round 2 post-rewrite full regression retest

- Baseline tested: current canon after the WUX-011 resolution was rechecked against both legal reads for F-022; WUX-012 remained unchanged.
- Coverage: F-001 ~ F-024 cumulative suite.
- Result: 22 pass / 0 revise / 2 block-deferred.
- Regressions from prior PASS: none. F-001 ~ F-021 and F-024 remain pass; F-018 remains the existing block-deferred item and F-023 remains block-deferred for the independent combat-puppet read only.
- Fixed from pre-rewrite revise: F-022 铁伞书生型 moved from revise to pass after confirming both legal canon-grounded reads are supported.
- New tickets opened: none.
...
- Round 2 cumulative retest：24 cumulative fantasies; 21 pass / 1 revise / 2 block-deferred; no prior PASS regressions; added F-021~F-024 and opened WUX-011~WUX-012.
- Round 2 post-rewrite retest：24 cumulative fantasies; 22 pass / 0 revise / 2 block-deferred; F-022 fixed to pass after WUX-011 resolution; no regressions; F-018 combat companion and F-023 independent puppet remain block-deferred.
