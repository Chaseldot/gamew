...
The `stories.html` page becomes the long-form story showcase. It mounts `showcase/content/03_Main_Story/classic-route-showcase.md` as the core "明档线" work and embeds selected `assets` images into the story flow.
...
- **Art:** Complete `assets` gallery with type filters.
