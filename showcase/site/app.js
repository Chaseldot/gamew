...
function renderHome() {
  ...
  root.innerHTML = `
    ${pageHero({
      ...
      image: 'assets/art/library/01-第一章-山水县境/00-章节地图/第一章-章节地图-山水县境封境总览.jpg',
      actions: [
...
function pageSummary(page) {
  const summaries = {
    art: '完整 assets 作品库，按地图、地点、场景、战斗和人物筛选。',
...
function renderWorld() {
  root.innerHTML = `
    ...
    <section class="band">
      <div class="section-inner feature-split">
        <figure class="wide-figure">
          <img src="assets/art/library/00-人物探索/人物-队伍概念-核心队友阵容.jpg" alt="队伍阵容探索">
...
function renderFactionsCharacters() {
  root.innerHTML = `
    ...
    <section class="band">
      <div class="section-inner feature-split">
        <figure class="wide-figure">
          <img src="assets/art/library/00-人物探索/人物-队伍镜头-雨夜客栈.jpg" alt="雨夜客栈队伍镜头">
...
function renderInitialScript() {
  root.innerHTML = `
    ${pageHero({
      ...
      image: 'assets/art/library/00-风格探索/世界基调/风格探索-边关驿站山口.png',
...
function renderSystems() {
  root.innerHTML = `
    ${pageHero({
      ...
      image: 'assets/art/library/01-第一章-山水县境/04-战斗图/第一章-战斗-旧镖道林间伏击点.png',
    })}
...
function renderArt() {
  ...
  root.innerHTML = `
    ${pageHero({
      ...
      image: 'assets/art/library/02-第二章-槐安古道/00-章节地图/第二章-章节地图-槐安古道黄沙边关总览.jpg',
    })}
