...
const primaryFactions = [
  { name: '缉武司', type: '公开政治轴', motto: '武人入册，天下止戈。', figure: '裴照 / 沈照微', promise: '公开律法、武人入册、封境救灾和可追责审案。', shadow: '风险治理扩大后，会把可能作乱提前写成准罪名。' },
  { name: '同尘盟', type: '公开政治轴', motto: '江湖事，江湖了。', figure: '楚横山 / 陆行舟', promise: '江湖自治、护乡护路、证人保护和民间动员。', shadow: '复仇和清算可能压倒证据程序，制造新的沉默。' },
  { name: '照影局', type: '寄生暗线', motto: '照见人心，先断祸端。', figure: '白微尘 / 司命', promise: '预测灾祸、提前处置、用母局权限维持所谓大局。', shadow: '把人压缩成档案和风险概率，提前裁决武人命运。' },
  { name: '慈心医脉', type: '关键中间势力', motto: '先救眼前人。', figure: '桑芷 / 阮清辞', promise: '救治宿主、识别药性、保留治疗权。', shadow: '治疗接口也可能成为暗植种针的伪装。' },
  { name: '百工坞', type: '关键中间势力', motto: '机关无善恶，看谁扣机簧。', figure: '唐小砚 / 唐叙白', promise: '机关图、阵钥、铃阵反制和母局改造可能。', shadow: '技术中立会让控制系统变得可执行。' },
  { name: '鬼市', type: '关键中间势力', motto: '天下没有不能买的命，只有开不起的价。', figure: '任无踪 / 阎三更', promise: '身份、证词、牒录交易、地下入口和无路者藏身处。', shadow: '真相、人命和身份都可能被拍卖或反卖。' },
];

const localFactions = [
  { name: '山神寨', type: '地方势力', motto: '官道不容人，山路自有路。', figure: '楚横山', promise: '收留山民、逃亡武人和官道不容之人。', shadow: '路税、走私、藏匿重犯与侠义混在一起。' },
  { name: '边地部族', type: '地方势力', motto: '风沙可挡，牒针不可入骨。', figure: '霍青鸢', promise: '保护族人不被边军、江湖和武籍系统吞没。', shadow: '夹在商路、边军、缉武司和江湖旧怨之间求生。' },
];
