...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Append a GameW imagegen prompt/reference record to assets/generation-log.md."
    )
    parser.add_argument("--repo", default=".", help="GameW repository root")
    parser.add_argument("--log", default="assets/generation-log.md", help="Log path relative to repo")
    ...
    parser.add_argument("--asset", help="Final assets path when accepted")
